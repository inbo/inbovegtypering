#### FUNCTIONS (Ward Langeraert https://github.com/inbo/mbag-mas/blob/main/source/R/taxon_mapping.R)
...
run_example <- FALSE
if (run_example) {
  # Load taxon matching functions
  source("source/R/taxon_mapping.R")

  # Create example dataset
  example_specs <- c("Gele Kwikstaart", "Spreeuw", "Roodborst", "Eekhoorn",
                     "Merel", "Hop", "Hop", "Haas", "Veldmuis", "Aardmuis")
  example_df <- data.frame(
    id = seq_along(example_specs),
    dwc_vernacularName = example_specs,
    dwc_class = c("Aves", "Aves", "Aves", "Mammalia", "Aves", "Aves",
                  NA, "Mammalia", "Mammalia", "Mammalia"),
    dwc_kingdom = c(rep("Animalia", 6), "Plantae", rep("Animalia", 3))
  )
  example_df
