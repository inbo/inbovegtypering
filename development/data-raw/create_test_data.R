...
write_csv2(example_recordings,
           file.path("development",
                     "zzz_local_data",
                     "interim",
                     "example_recordings.csv"))
...
write_csv2(example_synoptics,
        file.path("development",
                  "zzz_local_data",
                  "interim",
                  "example_synoptics.csv"))


save(example_recordings, example_synoptics,
     file = file.path("development", "data", "example_data.rda"))

#in het pakket zelf:
save(example_recordings, example_synoptics,
     file = file.path("data", "example_data.rda"))
